...
Your function should use slice within a loop and return an array of each successive string array from losing letters to the sharpener, until nothing is left.
...
const listFoods = (recipe) => {
  ...
  for(let i = 0; i < recipe.ingredients.length; i++){
    ...
    const slicedAgain = slicedArray.slice(slicedArray.indexOf(" ")+1);
...
Write a function named removeLastCharacters that takes in a string and a number. The numberOfCharacters argument determines how many characters will be removed from the end of the string. Return the arraying string.
